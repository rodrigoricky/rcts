...
const ProcessOne = () => {
    return (
        ...
        <div className="section section-padding bg-color-light pb--70">
            <SectionTitle 
                subtitle="Process"
                title="Bringing Your Ideas to Life: Our Innovative Process"
                description="We bring your revolutionary ideas to life with the right solutions for your business."
                textAlignment=""
                textColor="mb--90"
            />
