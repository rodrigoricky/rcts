...
const CounterUpOne = () => {
    return (
        <div className="section section-padding bg-color-dark">
            ...
            <SectionTitle 
                    subtitle="Achieve Business Breakthrough"
                    title="Your Partner in Digital Transformation."
                    description="Our vision is to bridge connections through an enhanced digital experience by creating the most convenient tools and empower enterprises through specialized solutions made more accessible. "
